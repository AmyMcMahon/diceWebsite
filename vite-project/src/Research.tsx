...
const Research: React.FC = () => {
    return (
        ...
        <div style={{marginLeft:"20px", marginRight:"20px"}}>
            ...
            <p>I have chosen to segment my market using demographic. This is where you section your market based on some identifiable trait that means they have similar needs and wants. I will cater to the demographic of primary school students of age five to twelve who are studying maths. </p>
            <h2>User Persona:</h2>
